...
insert into IntermediatePoint values(((E'2428b465-7553-4bd9-966d-9858bf1f818d')), ((E'e4f8c3cb-0550-49a2-990c-a621a7d41b5b')), ST_GeographyFromText('SRID=4326;POINT(((E'106.652234')) ((E'10.768846')))'))
insert into IntermediatePoint values(((E'87ab9d9a-93b6-41a2-88be-5bd373172ba3')), ((E'e4f8c3cb-0550-49a2-990c-a621a7d41b5b')), ST_GeographyFromText('SRID=4326;POINT(((E'106.652234')) ((E'10.768846')))'))

select R.RouteID, R.RouteName from BusRoute R, BusMovement M where R.RouteID = M.RouteID and (BusStationFrom = :StationID or BusStationTo = :StationID);